...
<div class="w3-main section-container" >
 ...
 <div>
 	<h2>Manage Eggs</h2>
  <a href="add-eggs.php" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add New Record</a><br><br>
 <div class="table-responsive">
 	<table class="table table-hover table-striped" id="table">
        ...
        <th></th>
 		...
 		<tbody>
 			<?php
       $all_eggInventory = $db->query("SELECT * FROM egginventory ORDER BY id DESC");
       $fetch = $all_eggInventory->fetchAll(PDO::FETCH_OBJ);
       foreach($fetch as $data){
        ...
        ?>
          <tr>
            ...
            <td><?php echo $data->eggs_collected ?></td>
            <td><?php echo $batch->batch_no ?></td>
            <td><?php echo $data->date_collected ?></td>
            <!-- <td>
               <div>
                  <a
